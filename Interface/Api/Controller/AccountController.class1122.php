...
class AccountController extends ApiController
{
        ...
        if (!empty($user) && !empty($pwd)) {
            ...
            if (!empty($resn)) {
                ...
                $us = M('userinfos')->alias('u')
                    ->join("left join wht_rooms as r on r.roomid = u.roomid")->where($where1)->field('u.username,u.email,u.nickname,u.headimage,u.phone,u.sharecode,u.gradeid,u.expervalue,u.ninemoney,u.balance,u.signature,u.qq,u.weixin,u.sina,r.roomcode,u.usertype,u.gender,u.roomid,u.job,u.emcid,u.emcpwd')->find();
    ...
    public function register()
    {
        ...
        if (!empty($rm["username"]) && !empty($rm["userpwd"])) {
            ...
            $us = M('userinfos')->alias('u')
                ->join("left join wht_rooms as r on r.roomid = u.roomid")->where($uwhere)->field('u.username,u.email,u.nickname,u.headimage,u.phone,u.sharecode,u.gradeid,u.expervalue,u.ninemoney,u.balance,u.signature,u.qq,u.weixin,u.sina,r.roomcode,u.roomid,u.usertype,u.gender,u.job,u.emcid,u.emcpwd')->find();
            $result = array(
                'token' => $accesstoken,
                'type' => 2,
                ...
                'roomcode' => $us['roomcode'] ? $us['roomcode'] : '',
