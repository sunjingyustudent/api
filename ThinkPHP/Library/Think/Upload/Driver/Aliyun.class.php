...
class Aliyun{
    ...
    'AccessKeyId' => 'qz2BRTXV7piA6zcK', //OSS用户
    'AccessKeySecret' => 'iwEFsvsYphgl0xJKOYoxbKPRvm4EAN', //OSS密码
    'domain'        =>'jdcjapp',   //OSS空间路径
    'Bucket'   => 'http://oss-cn-hangzhou.aliyuncs.com', //空间名称
    'Endpoint'  => '3600', //超时时间
    );
